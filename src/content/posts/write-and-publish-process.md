...
date: 2026-08-26
lastMod: 2026-09-08T21:06:06+08:00
summary: 记录一篇新文章从创建、写作、预览到发布的完整流程，方便日后查阅。
category: 教程
tags: [站点]
---

欢迎来到 **Nekooy小站**，我的个人博客。这篇把「一篇新文章如何从创建到发布上线」的完整流程记录在这里，方便日后查阅，也让大家了解这个站点是怎么运作的。整个流程只有四步：**创建 → 写作 → 预览 → 推送**。
